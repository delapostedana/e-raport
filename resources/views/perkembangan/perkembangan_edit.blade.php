...
@section('tittle','Edit Perkembangan')

@section('page-tittle','Edit perkembangan')

@section('breadcrumb')
<li class="breadcrumb-item"><a href="#">Kategori Penilaian</a></li>
<li class="breadcrumb-item active" aria-current="page">Edit Perkembangan</li>
@endsection
...
<div class="row">
    ...
    <div class="col-sm-12">
        <div class="card-body">
            <h3 class="mb-4" style="color: #54667a"><i class="mdi me-2 mdi-file"></i> Form Edit Perkembangan</h3>
            @foreach ($perkembangan as $data)
            <form method="post" action="{{ url('perkembangan/update') }}">
                @csrf

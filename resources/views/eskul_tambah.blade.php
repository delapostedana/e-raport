...
<div class="row">
    ...
    <div class="col-sm-12">
        <div class="card-body">
            <h3 class="mb-4" style="color: #1e88e5"><i class="mdi me-2 mdi-book"></i> Form Tambah Eskul</h3>
            <form method="post" action="{{ url('proses') }}">
                @csrf
                <div class="form-floating mb-3">
                    <input type="text" class="form-control border border-info" placeholder="Nama Eskul" name="nama" required>
                    <label><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                        ...
                        </svg><span class="border-start border-info ps-3">Nama Eskul <span class="text-danger">*</span></span></label>
                </div>

...
@section('tittle','Edit Peserta Didik')

@section('page-tittle','Edit Peserta Didik')
...
<div class="row">
    ...
    <div class="col-sm-12">
        <div class="card-body">
            <h3 class="mb-4" style="color: #54667a"><i class="mdi me-2 mdi-file"></i> Form Edit Peserta Didik</h3>
